					...
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<li class="story-startup-tr">
								...
								<div class="bdp-right">
									<span class="fas fa-question-circle bdp-tooltips-icon bdp-tooltips-icon-color"><span class="bdp-tooltips"><?php esc_html_e( 'Select story startup text color', 'blog-designer-pro' ); ?></span></span>
						...
						<ul class="bdp-settings bdp-lineheight">
							...
							<li class="bdp_related_post_media_custom_size_tr">
								...
								<div class="bdp-right">
									<span class="fas fa-question-circle bdp-tooltips-icon bdp-tooltips-icon-color"><span class="bdp-tooltips"><?php esc_html_e( 'Enter custom size for product media', 'blog-designer-pro' ); ?></span></span>
									<div class="bdp_media_custom_size_tbl">
										<p> <span class="bdp_custom_media_size_title"><?php esc_html_e( 'Width (px)', 'blog-designer-pro' ); ?> </span> <input type="number" onkeypress="return isNumberKey(event)" min="0" name="related_post_media_custom_width" class="media_custom_width" id="related_post_media_custom_width" value="<?php echo ( isset( $bdp_settings['related_post_media_custom_width'] ) && '' != $bdp_settings['related_post_media_custom_width'] ) ? esc_attr( $bdp_settings['related_post_media_custom_width'] ) : ''; ?>" /></p>
							...
							<li class="related_post_text">
								...
								<div class="bdp-right">
									...
									<input type="text" name="related_post_title" id="related_post_title" value="<?php if ( isset( $bdp_settings['related_post_title'] ) ) { echo esc_attr( $bdp_settings['related_post_title'] ); } ?>" placeholder="<?php esc_html_e( 'Enter Related Post Title', 'blog-designer-pro' ); ?>">
								</div>
							</li>
							<li>
							...
							<li>
								...
								<div class="bdp-right">
									<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Display content from product content or description', 'blog-designer-pro' ); ?></span></span>
									...
									<div class="typo-field">
										...
										<select name="txtSocialTextFont" id="txtSocialTextFont">
											...
											foreach ( $font_family as $key => $value ) {
												...
												echo "<option value='" . esc_attr( str_replace( '"', '', $value['label'] ) ) . "'";
												if ( '' != $txt_social_text_font && ( str_replace( '"', '', $txt_social_text_font ) == str_replace( '"', '', $value['label'] ) ) ) {
													echo ' selected';
												}
												echo '>' . esc_attr( $value['label'] ) . '</option>';
												$cnt++;
