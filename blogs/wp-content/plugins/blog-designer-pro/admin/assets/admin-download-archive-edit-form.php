					...
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<li class="enable_print_page">
								...
								<div class="bdp-right">
									<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Show print page on download archive product page', 'blog-designer-pro' ); ?></span></span>
									<?php
