						...
						<ul class="bdp-settings">
							...
							<li>
								...
								<div class="bdp-right">
									...
									<?php $template_post_margin = ( isset( $bdp_settings['template_post_margin'] ) && '' != $bdp_settings['template_post_margin'] ) ? esc_html( $bdp_settings['template_post_margin'] ) : 20; ?>
					...
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<li class="ticker-label-text">
								...
								<div class="bdp-right">
									<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Enter text for Ticker label', 'blog-designer-pro' ); ?></span></span>
							...
							<li class="ticker_autoplay_tr">
								...
								<div class="bdp-right">
									<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Show Ticker autoplay', 'blog-designer-pro' ); ?></span></span>
							...
							<li class="ticker_autoplay_interval">
								...
								<div class="bdp-right">
									<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Enter ticker autoplay intervals', 'blog-designer-pro' ); ?></span></span>
							...
							<li class="enable_print_page">
								...
								<div class="bdp-right">
									<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Show Print page on archive page', 'blog-designer-pro' ); ?></span></span>
									<?php
				...
				<div id="bdpmedia" class="postbox postbox-with-fw-options" style=<?php echo esc_attr( $bdpmedia_class_show ); ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<ul class="display_image_tr_main">
