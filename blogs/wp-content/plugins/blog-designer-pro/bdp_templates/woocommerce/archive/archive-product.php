...
<div class="container">
	<div class="row">		
		<div class="col-sm-8 col-xs-12 ">
			...
			if ( 'boxy-clean' === $bdp_theme || 'crayon_slider' === $bdp_theme || 'sunshiny_slider' === $bdp_theme || 'sallet_slider' === $bdp_theme || 'colorful_sliding' === $bdp_theme || 'colorful_sliding' === $bdp_theme || 'blog_carousel' === $bdp_theme ) {
				$unique_id = wp_rand();
			}
