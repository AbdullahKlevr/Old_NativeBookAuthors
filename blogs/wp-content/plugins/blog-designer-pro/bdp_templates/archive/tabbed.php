				...
				<div class="bdp-post-inner-content">
					...
					?>
						<div class="bdp-tabbed-meta-content">
							...
							if ( 1 == $display_author ) {
								echo '<span class="author">' . esc_html__( 'By', 'blog-designer-pro' ) . '&nbsp;' . Bdp_Author::get_post_auhtors( $post->ID, $bdp_settings ) . '</span>';
							}
						...
						if ( 0 == $tabbed_post_style ) {
							...
							<div class="bdp-post-content">
								...
								$txtExcerptlength = isset( $bdp_settings['txtExcerptlength'] ) ? $bdp_settings['txtExcerptlength'] : 1;
								$txtReadmoretext  = isset( $bdp_settings['txtReadmoretext'] ) ? $bdp_settings['txtReadmoretext'] : 1;
								echo Bdp_Posts::get_content( $post->ID, $bdp_settings, $rss_use_excerpt, $txtExcerptlength );
								$read_more_link = isset( $bdp_settings['read_more_link'] ) ? $bdp_settings['read_more_link'] : 1;
								$read_more_on   = isset( $bdp_settings['read_more_on'] ) ? $bdp_settings['read_more_on'] : 1;
								$readmoretxt    = '' != $txtReadmoretext ? $txtReadmoretext : esc_html__( 'Read More', 'blog-designer-pro' );
