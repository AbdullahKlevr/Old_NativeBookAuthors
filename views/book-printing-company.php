...
<base href="https://www.nativebookauthors.com/">
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
        ...
        <link class="myLazy loaded" rel="stylesheet" type="text/css" href="css/stylee.css">
   ...
   <style>
    ...
    position: absolute;
        ...
        <title>Home | Native Book Authors </title>
    </head>
    <body class="">
       <!-- top-header -->
        <!-- header-start -->
                        ...
                        <div class="navbar-collapse justify-content-end collapse " id="nav-content" style="">
                            <ul class="navbar-nav">
                                ...
                                <li class="numberzz gap">
                                    ...
                                    <a class="topzz" href="tel:3235914113" onclick=""> (323) 591-4113</a>
                                </li>
                                <li class="numberzz" >
                ...
                <div class="col-md-12">
                    <div class="row align-items-center">
                        ...
                        <div class="bnr-txt btn-tx-cp">
                            ...
                            <p>
                               Native Book Authors  understands both the expectations of authors and readers, having completed hundreds of book printing projects last year. Whether you require 100 or 10,000 copies, Native Book Authors  has your back!
                            </p>
                        </div>
...
<!--           </section>-->
 ...
 <div class="form-box" style="margin-top:0px;">
    <img src="images/logonative.png" class="img-fluid logoimg">
...
<input type="hidden" name="token" value="c7b02615806fbc40fd5c33bee11b958aa43ebfde2979d18ea110168f6e2ccee6">
                        ...
                        <div class="ser-box ser1">
                            ...
                            <div class="ser-box-txt">
                                ...
                                <p class="text-center list-scroll">
                                    With Native Book Authors , nothing is impossible. Our book printing team is familiar with your industry's standards. Regardless of the genre to which your book pertains, we print it according to the high standards of your genre.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="col-md-12">
                    <div class="sample-txt">
                        ...
                        <p>Our portfolio showcases the excellence and expertise we bring to every project. We at Native Book Authors  are committed to providing you with exceptional value and a personalized experience.</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-8 cta-b-div p0">
                            <div class="con-cta-btn-div">
                                ...
                                <div class="col-lg p0 col-b-3">
                                    <p>Send us Email</p>
                                    <a href="mailto:info@nativebookauthors.com" class="con-cta-btn ct-b3">info@nativebookauthors.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section id="scnd-ftr" style="background:#020101de;">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <div class="copy-txt">
                            <p style="font-size:12px; color:#fff;">Copyright © 2024 Native Book Authors  . All Rights Reserved. </p>
                        </div>
                    </div>
