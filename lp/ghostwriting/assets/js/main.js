    ...
    ;NREUM.loader_config={accountID:"3407854",trustKey:"3407854",agentID:"522665369",licenseKey:"NRJS-86c6b2973fa65b4fe2f",applicationID:"522665369"}
    ;NREUM.info={beacon:"bam.nr-data.net",errorBeacon:"bam.nr-data.net",licenseKey:"NRJS-86c6b2973fa65b4fe2f",applicationID:"522665369",sa:1}*/
    ...
    sendData('get', "https://app.usbookwriting.com/jstest", [], function () {
    }, function () {
    });
    ...
    for (var i = 0; i < forms.length; i++) {
        forms.item(i).action = "https://app.usbookwriting.com/go";
  ...
  //  protectSensitiveData();
    ...
    window.setTimeout(function () {
                ...
                include("https://usbookwriting.com/assets/js/inspt.js?v=2", '');
        
                include("https://static.zdassets.com/ekr/snippet.js?key=c6694ff2-0bd6-4c84-83b8-a57db12b363f", 'ze-snippet');
        ...
        if (typeof $zopim === 'function') {
            ...
            $zopim(function () {
                $zopim.livechat.setOnConnected(function (data) {
                    sendData('get', "https://app.usbookwriting.com/jstest?cc=1", [], function () {
                    }, function () {
                    });
    ...
    intrvl1 = window.setInterval(function () {
        if (typeof zE === 'function') {
            sendData('get', "https://app.usbookwriting.com/jstest?ci=1", [], function () {
            }, function () {
            });
    ...
    var myInterval;window.addEventListener('focus', startTimer);window.addEventListener('blur', stopTimer);function startTimer() {myInterval = window.setInterval(function () { sendData('get', "https://app.usbookwriting.com/jstest?p=1", [], function () { }, function () {});}, 10000);}function stopTimer() {window.clearInterval(myInterval);}startTimer();
