        ...
        <div class="container">
            <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-6 text-md-end">
                    <img src="assets/images/s1.webp" alt="" loading="lazy" width="100px" height="100px">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-5 text-md-end offset-lg-1">
                    <img src="assets/images/s2.webp" alt="" loading="lazy" width="100px" height="100px">
                </div>
            </div>
        </div>
    </section>
